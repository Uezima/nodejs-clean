import { DbLoadSurveyResult, LoadSurveyResultRepository, LoadSurveyByIdRepository } from './db-load-survey-result-protocols'
...
describe('DbLoadSurveyResult UseCase', () => {
  ...
  test('Should call LoadSurveyResultRepository with correct values', async () => {
    ...
    expect(loadBySurveyIdSpy).toHaveBeenLastCalledWith('any_survey_id', 'any_account_id')
  })
